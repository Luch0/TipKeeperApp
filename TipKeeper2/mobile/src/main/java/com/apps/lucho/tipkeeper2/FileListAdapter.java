...
public class FileListAdapter extends BaseAdapter {
    ...
    private final static int ICON_FOLDER = R.drawable.ic_audiotrack;
    private final static int ICON_FILE = R.drawable.ic_audiotrack_light;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null)
            row = mInflater.inflate(R.layout.activity_main_tip_keeper, parent, false);
